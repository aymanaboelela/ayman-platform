...
اختار واحد **قبل** ما ترفع أول بريزنتيشن كبير:

- **نزّل حد المنصة لـ ٩٥ ميجا** — أبسط وأوضح حاجة. الرفض بيبقى من المنصة
  برسالة عربية مفهومة بدل ٤١٣ غامضة من Cloudflare.
