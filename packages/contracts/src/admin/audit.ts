...
export const AUDIT_ACTIONS = [
  ...
  'homework:return',
  /*
   * لوحة الشرف بالإيد — نشر اسم طالب قاصر على صفحة عامة بدوسة زرار.
   *
   * تلات أكشنز مش واحد، ومفيش فيهم زيادة: «مين نشر اسم الطالب ده، وإمتى»
   * سؤال بيتسأل بعد شكوى من أهل، و«مين شاله» سؤال تاني خالص. والتعديل بيغيّر
   * المركز والسبب — يعني بيغيّر اللي مكتوب على الصفحة العامة من غير ما يضيف
   * ولا يشيل صف.
   *
   * `honor:remove` بيحمل الاسم والسبب في الـmetadata: بعد المسح الصف بيبقى
   * راح، والسطر ده بيبقى الأثر الوحيد إنه كان موجود.
   *
   * الورقة المثبّتة من شاشة التصحيح مش هنا — دي بتتسجّل مع `attempt:*`،
   * ومكانها الطبيعي مع الورقة نفسها.
   */
  'honor:add',
  'honor:update',
  'honor:remove',
