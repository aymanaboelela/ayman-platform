...
const admin = {
  nav: {
    ...
    homework: 'الواجبات',
    /**
     * لوحة الشرف — تحت «تصحيح الورق» في مجموعة التدريس.
     *
     * جنبه مش بالصدفة: الورقة المثبّتة بتتحط من شاشة التصحيح، والصف اليدوي
     * بيتحط من هنا، والاتنين بيطلعوا على نفس اللوحة. الشاشتين جنب بعض عشان
     * حد بيدوّر على «مين على اللوحة» مايفضلش يلف.
     */
    ...
    /** «السناتر» — the physical centres: their weekly slots, who booked
     *  which, the door scanner and the money the classes brought in. Its own
     *  group: it is run by different people (whoever stands at the door) and
     *  read for a different reason than anything under «التدريس». */
    centers: 'السناتر',
    centersScan: 'تسجيل الحضور',
    centersFinance: 'فلوس السناتر',
   ...
   *
   * الشاشة بتعرض المصدرين: الصف اللي المدرّس كتبه (بيتعدّل ويتمسح من هنا)،
   * والورقة المثبّتة من شاشة التصحيح (للعرض، وبتتفك من مكانها). الكوبي كلها
   * بتفرّق بينهم بالكلام مش بلون، عشان اللي بيبص يعرف إيه اللي يقدر يغيّره
   * من هنا.
   */
  honorBoard: {
    title: 'لوحة الشرف',
    lead: 'مين على اللوحة دلوقتي، ومين كان عليها قبل كده. تقدر تحط حد بإيدك بتاريخه ومركزه.',
    empty: 'مفيش حد على اللوحة لسه.',
    /** الزرار اللي بيفتح الديالوج. */
    add: 'ضيف طالب للوحة',
    /** عنوان الديالوج وهو بيضيف، وهو بيعدّل. */
    addTitle: 'ضيف طالب للوحة الشرف',
    editTitle: 'عدّل التكريم',
    /** ⚠️ السطر ده بيتقري قبل أول دوسة تنشر اسم طالب على صفحة عامة. */
    publishWarning:
      'الاسم والصورة دول بيظهروا على الصفحة الرئيسية لأي حد يفتح الموقع.',

    /* ── البحث عن الطالب ─────────────────────────────────────────────────── */
    searchLabel: 'الطالب',
    searchPlaceholder: 'اكتب اسمه أو رقم تليفونه',
    /** بيتعرض قبل ما يكتب حاجة — حرفين هو الحد الأدنى للبحث. */
    searchHint: 'اكتب حرفين على الأقل.',
    searching: 'بندوّر…',
    searchEmpty: 'مفيش حد بالاسم ده.',
    searchFailed: 'البحث مشتغلش — نجرّب تاني',
    /** تحت اسم الطالب في نتيجة البحث — `{n}` عدد مرات تكريمه قبل كده. */
    searchPinned: 'اتكرّم {n} مرة قبل كده',
    /** الزرار اللي بيشيل الطالب المختار ويرجّع البحث. */
    changeStudent: 'غيّر الطالب',

    /* ── الفورم ──────────────────────────────────────────────────────────── */
    dayLabel: 'تاريخ اللوحة',
    /** ليه التاريخ مش «النهاردة» أوتوماتيك. */
    dayHint: 'اللي في نفس اليوم بيطلعوا على لوحة واحدة.',
    rankLabel: 'المركز',
    /** تحت المركز — ليه الرقم مش محسوب. */
    rankHint: 'إنت اللي بتقوله. المركز بيتحسب جوّه الكورس، مش على اللوحة كلها.',
    /** ⚠️ بيتعرض لما المركز ده متاخد في نفس الدور ونفس الكورس. */
    rankTaken: 'المركز ده متاخد في اللوحة دي — اللي عليه هيتزحزح للّي بعده.',
    courseLabel: 'الكورس',
    /** الاختيار الفاضي في قايمة الكورسات. */
    courseNone: 'من غير كورس',
    courseHint: 'من غير كورس، الشارة بتتكتب من سنة الطالب وشعبته.',
    reasonLabel: 'سبب التكريم',
    reasonPlaceholder: 'الأول على الدفعة',
    reasonHint: 'السطر ده بيتطبع تحت اسمه على الكارت.',
    photoLabel: 'صورة التكريم',
    photoHint: 'لو سيبتها فاضية، بتتستعمل صورة لوحة الشرف اللي في ملفه — ولو مفيش، بيظهر أول حرفين من اسمه.',
    ...
    /* ── اللي على الشاشة ─────────────────────────────────────────────────── */
    /** عنوان القسم اليدوي جوّه الدور. */
    manualTitle: 'متحطّين بالإيد',
    /** عنوان قسم الورق المثبّت جوّه الدور. */
    examTitle: 'من امتحانات مثبّتة',
    /** تحت عنوان قسم الورق — ليه مفيش زرار مسح جنبه. */
    examHint: 'دول بيتحطوا ويتشالوا من شاشة تصحيح الورق.',
    /** الرابط اللي بيودّي على الورقة نفسها. */
    examOpen: 'افتح الورقة',
    edit: 'عدّل',
    remove: 'شيله من اللوحة',
    /** ⚠️ السؤال اللي بيتسأل قبل المسح — `{name}` اسم الطالب. */
    removeConfirm: 'تشيل {name} من لوحة الشرف؟',
    removeConfirmHint: 'هيختفي من الصفحة الرئيسية ومن الأرشيف. الإشعار اللي وصله قبل كده بيختفي كمان.',
    /** تأكيد شيل ورقة امتحان من اللوحة. مختلف عن `removeConfirmHint` عن
     *  قصد: هناك التكريم نفسه بيتمسح، وهنا الورقة والدرجة مابيحصلهمش حاجة —
     *  اللي بيتشال هو الاسم من الصفحة العامة، والقرار أخف ولازم يقول كده. */
    examRemoveHint: 'الورقة والدرجة هيفضلوا زي ما هما — اللي هيتشال هو اسمه من اللوحة بس. تقدر ترجّعه من شاشة تصحيح الورق.',
    removing: 'بنشيله…',
    removeFailed: 'مقدرناش نشيله — نجرّب تاني',
    /** تحت عنوان الدور — `{n}` عدد الأسماء عليه. */
    roundCount: '{n} اسم',
    /** الشارة اللي جنب الاسم لما مايكونش فيه كورس ولا سنة. */
    noCourse: 'من غير شارة',
    /** زرار «عرض اللوحة» اللي بيفتح الصفحة العامة على الدور ده. */
    viewPublic: 'شوفها على الموقع',
  },
  grading: {
    title: 'تصحيح الورق',
  ...
  navBlurb: {
    ...
    '/admin/centers': 'السناتر ومواعيدها، ومين حاجز في كل ميعاد.',
    '/admin/centers/scan': 'كاميرا الموبايل على كارت الطالب — والحضور بيتسجّل.',
    '/admin/centers/finance': 'إيراد كل سنتر وكل ميعاد في الشهر.',
  ...
  settings: {
    ...
    sectionShipping: 'سعر شحن الكتاب',
    /**
     * المناطق التلاتة بأسماء الطالب مش بأسماء الكود — «صعيد» مش `far`.
     * الفئة اللي بتتحسب للطلب بتتجمّد وقت الطلب، فتغيير هنا بيمسّ الطلبات
     * الجديدة بس، واللي اتشحن فعلاً بيفضل بسعره.
     */
    shippingNote: 'السعر ده بيتحسب على الطلبات الجديدة بس — اللي اتطلب خلاص بيفضل بسعره.',
    shippingCairoGiza: 'القاهرة والجيزة',
    shippingDelta: 'وجه بحري',
    shippingFar: 'صعيد وسينا والبحر الأحمر',
    shippingUnit: 'بالجنيه',
    ...
    /**
     * التلات صور دول كانوا في السكيما وفي الداتابيز ومالهمش خانة في الفورم —
     * يعني الطريقة الوحيدة لربط صورة مدرّس كانت `PATCH` على الـAPI بإيد حد
     * تاني. الهنتات بتقول **فين بتظهر**، لأن «صورة المدرّس» لوحدها تلات حاجات
     * مختلفة والواحدة منهم مقاسها وقصّها مختلف.
     */
    heroImage: 'صورة الشاشة الأولى',
    heroImageHint: 'بتترسم ورا كلام أول شاشة في الصفحة الرئيسية. ارفع صورة عرضها ١٦٠٠ بكسل على الأقل.',
    portraitImage: 'صورة المدرّس',
    portraitImageHint: 'بتظهر في قسم «المدرّس» في الصفحة الرئيسية — صورة واقفة، الوش في التلت الأعلى.',
    loginImage: 'صورة صفحة الدخول',
    loginImageHint: 'اللوحة اللي جنب فورم تسجيل الدخول وإنشاء الحساب.',
  ...
  /**
   * شاشة الصلاحيات — «المساعد يقدر يعمل إيه».
   *
   * الأسماء هنا بتتعرض للمدرّس، مش للمبرمج. `payment:review` معناه «يوافق
   * على التحويلات» مش «payment review»، واللي بيقرا الشاشة بيقرر على أساس
  ...
  roles: {
    ...
    /**
     * قسم الفريق — «مين المساعدين» و«ضيف واحد».
     *
     * شبكة الصلاحيات تحته بتجاوب «المساعد بيقدر يعمل إيه»، وماكانش فيه حتة
     * تجاوب «مين المساعدين أصلًا». السؤالين مختلفين، وde كان ناقص.
     */
    staff: {
      title: 'الفريق',
      lead: 'اللي معاهم صلاحية دخول اللوحة. الصلاحيات نفسها من الجدول اللي تحت.',
      searchLabel: 'دوّر بالاسم أو الموبايل أو الإيميل',
      searchPlaceholder: 'اكتب حرفين على الأقل',
      searching: 'بيدوّر…',
      noResults: 'مفيش حساب بالاسم ده.',
      empty: 'لسه مفيش حد في الفريق غيرك.',
      reasonLabel: 'السبب',
      reasonPlaceholder: 'ليه بتضيفه؟',
      add: 'ضيفه للفريق',
      adding: 'بيضيف…',
      remove: 'شيله من الفريق',
      removing: 'بيشيل…',
      /** ⚠️ رسالة نجاح بتوصف اللي حصل بالظبط: الدور اتغيّر، مش «اتحفظ». */
      added: 'اتضاف للفريق.',
      removed: 'رجع طالب.',
      failed: 'مقدرناش نغيّر الدور. نجرّب تاني.',
      /** اللي بيتعرض جنب كل اسم في الليستة. */
      roleOwner: 'مساعد',
      /** الحساب اللي إنت داخل بيه — مالوش زرار شيل. */
      you: 'إنت',
    },
    baselineTitle: 'معاه دايمًا',
    baselineHint: 'ده أساس الرول، مكتوب في الكود ومش بيتقفل من هنا.',
    grantableTitle: 'تقدر تفتحله',
    save: 'احفظ الصلاحيات',
    saving: 'بيحفظ…',
    saved: 'اتحفظت.',
    saveFailed: 'مقدرناش نحفظ الصلاحيات. نجرّب تاني.',
    empty: 'مفيش صلاحيات زيادة تتفتح للرول ده.',
    /** أسماء الموارد — العنوان فوق كل مجموعة. */
    group: {
      'course': 'الكورسات',
      'profile': 'البروفايل',
      'section': 'الوحدات',
    ...
    action: {
      ...
      'unlock': 'يفتح',
      'access': 'يدخل',
      'read-admin': 'يشوف (لوحة)',
      'role-change': 'يغيّر الرول',
      'ban': 'يحظر',
      'set-password': 'يغيّر الباسورد',
      'reply': 'يرد',
      'close': 'يقفل',
      'resolve': 'يحل',
      'send': 'يبعت',
  ...
  cancelSubscriptionConfirm: 'إلغاء الاشتراك',
    /** إجباري — نفس قاعدة شاشة الفلوس. الإلغاء من صفحة الطالب كان بيتم من
     *  غير أي سبب مكتوب، يعني صف ملغي في الداتابيز ومحدش يعرف ليه بعد شهرين. */
    cancelReasonLabel: 'السبب',
    /** مقفول افتراضيًا: قطع الوصول حاجة، ورجوع الفلوس حاجة تانية. */
    cancelRefundAsk: 'رجّعتله فلوسه؟',
    cancelRefundLabel: 'المبلغ اللي رجع (بالجنيه)',
    /** `{max}` — اللي الاشتراك ده جمعه. السقف الحقيقي على السيرفر؛ ده تلميح. */
    cancelRefundMax: 'أكبر مبلغ: {max} جنيه',
  ...
  historyKinds: {
     ...
     * «مساعد» مش «مالك».
     *
     * الرول اسمه `owner` في الكود لأنه اتكتب للمدرّس صاحب المنصة، بس اللي
     * بيقرا القايمة دي بيختار **لحد تاني** — و«مالك» جنب «مسؤول» بيقرا كأنه
     * أقوى، وهو العكس بالظبط.
     *
     * الاسم اللي بيوصف الصلاحيات هو اللي المفروض يتعرض: بيدرّس ويصحّح ويشوف
     * طلبته، ومابيلمسش فلوس ولا بيمسح حساب.
     */
    roleOwner: 'مساعد',
    roleOwnerHint: 'بيدرّس ويصحّح ويشوف الطلبة. مابيوصلش للفلوس ولا بيمسح حسابات.',
    roleAdminHint: 'كل حاجة، من غير استثناء — الفلوس والاستردادات ومسح الحسابات وسجل التدقيق.',
    roleStudent: 'طالب',
  ...
  finance: {
    ...
    /*
     * الفلوس اللي رجعت للطلبة — تحت المصروفات، ومع ذلك **مش** واحدة منهم.
     *
     * صاحب المنصة طلبها في المصروفات، والطلب مفهوم: فلوس خرجت. بس الحساب
     * هنا `صافي الربح = (الإيرادات − الاستردادات) − المصروفات`، فحطّها في
     * `expensesTotalCents` كان هيخصمها **مرتين** — والرقم اللي المفروض يكون
     * أرض ثابتة يبقى غلط بضعف المبلغ.
     *
     * فبتتعرض جنبهم بإجمالي خاص بيها، والسطر تحتها بيقول ليه — لأن رقم بيبان
     * تحت المصروفات ومش داخل في مجموعها لازم يفسّر نفسه، وإلا يقرا كغلط.
     */
    refundsRow: 'الفلوس اللي رجعت للطلبة',
    refundsRowNote: 'مخصومة من الإيرادات خلاص — مش مضافة للمصروفات عشان ماتتحسبش مرتين.',
  ...
  unlockCodes: {
    eyebrow: 'المبيعات',
    title: 'أكواد الفتح',
    subtitle: 'كود من ٦ حروف لطالب واحد — بيفتح محاضرة أو وحدة أو ترم أو الكورس كله، ومرة واحدة بس.',
    createTitle: 'كود جديد',
    createLead: 'اختيار الكورس، وبعدين اللي الكود هيفتحه.',
    step1: 'الكورس',
    step2: 'الكود يفتح إيه',
    step3: 'التفاصيل',
    coursePlaceholder: 'اختيار الكورس…',
    courseLoading: 'بنجيب محتوى الكورس…',
    courseEmpty: 'الكورس ده لسه مافيهوش وحدات.',
    draft: 'مسودة',
    /** A draft in the course dropdown — an `<option>` holds text only, so the
     *  marker rides in the label rather than as a badge. */
    draftOption: '{title} · مسودة',
    wholeCourse: 'الكورس كله',
    wholeCourseHint: 'كل المحاضرات — واللي هتنزل بعدين كمان.',
    terms: 'الترمات',
    months: 'الشهور',
    units: 'الوحدات والمحاضرات',
    wholeUnit: 'الوحدة كلها',
    wholeUnitHint: 'واللي هيتضاف ليها بعدين',
    lessonsCount: '{count} محاضرة',
    quiz: 'كويز',
    homework: 'واجب',
    unpublished: 'مش منشورة',
    selected: '{count} مختار',
    clearSelection: 'مسح الاختيار',
    quantity: 'عدد الأكواد',
    /** `aria-label`s on the stepper's − and + — the glyphs alone say nothing
     *  to a screen reader. */
    quantityLess: 'كود أقل',
    quantityMore: 'كود زيادة',
    quantityHint: 'كل كود لطالب واحد — لخمس طلبة يبقى ٥ أكواد لنفس المحتوى.',
    price: 'المبلغ المدفوع (جنيه)',
    /**
     * الكود المجاني — منحة، مش بيع.
     *
     * `priceCents` كان اختياري من الأول، وخانة فاضية بتسجّل `null` صح.
     * بس اللي كان بيتعرض «—» رمادية، والمدرّس مش عارف من الشاشة لو دي
     * منحة مقصودة ولا سعر حد نسي يكتبه. الاختيار بقى صريح والليستة
     * بتسمّيه.
     */
    priceFree: 'مجاني',
    priceFreeHint: 'منحة — مش بتتحسب في الفلوس ولا في الإيرادات.',
    priceHint: 'للتسجيل بس — مش بيدخل في حسابات الإيرادات.',
    note: 'ملاحظة',
    notePlaceholder: 'اسم الطالب أو رقمه، للرجوع ليه بعدين',
    generate: 'إنشاء الكود',
    generateMany: 'إنشاء {count} أكواد',
    generating: 'بننشئ…',
    nothingPicked: 'اختيار حاجة الكود يفتحها الأول.',
    readyTitle: 'الكود جاهز',
    readyManyTitle: '{count} أكواد جاهزة',
    readyLead: 'جاهز للإرسال على واتساب — وبيشتغل مرة واحدة بس.',
    newOne: 'كود تاني',
    copy: 'نسخ',
    copied: 'اتنسخ',
    copyAll: 'نسخ الكل',
    shareWhatsapp: 'إرسال على واتساب',
    shareText: 'كود فتح «{content}» في كورس «{course}»:\n\n*{code}*\n\nالتفعيل من «كود الكورس» في الحساب: {url}\nالكود بيشتغل مرة واحدة بس.',
    tiles: { unused: 'متاحة', used: 'اتستخدمت', revoked: 'اتلغت' },
    filters: { all: 'الكل', unused: 'متاحة', used: 'اتستخدمت', revoked: 'اتلغت' },
    allCourses: 'كل الكورسات',
    search: 'بحث بالكود أو اسم الطالب أو رقمه',
    columns: {
      code: 'الكود',
      content: 'بيفتح',
      student: 'الطالب',
    ...
    status: { unused: 'متاح', used: 'اتستخدم', revoked: 'اتلغى' },
    usedOn: 'اتستخدم {date}',
    notUsedYet: 'لسه محدش استخدمه',
    deletedStudent: 'حساب اتمسح',
    by: 'عمله {name}',
    kind: {
      course: 'الكورس كله',
      term: 'ترم',
    ...
    revoke: 'إلغاء',
    revokeUsed: 'سحب',
    revokeTitle: 'إلغاء الكود {code}؟',
    revokeBodyUnused: 'الكود هيبطّل يشتغل. محدش استخدمه لسه، فمفيش حاجة هتتقفل على حد.',
    revokeBodyUsed: 'اللي الكود فتحه لـ«{student}» هيتقفل حالًا. أي اشتراك تاني عنده مش هيتأثر.',
    revokeConfirm: 'تأكيد الإلغاء',
    revokeUsedConfirm: 'تأكيد السحب',
    back: 'رجوع',
    delete: 'حذف',
    deleteTitle: 'حذف الكود {code}؟',
    deleteBody: 'الكود هيتمسح نهائي — متاح بس للكود اللي محدش استخدمه.',
    deleteConfirm: 'تأكيد الحذف',
    /** The toasts after each of the three — «اتحفظ» read wrong on a code
     *  that was just cancelled. */
    revokeDone: 'الكود اتلغى.',
    revokeUsedDone: 'اللي الكود فتحه اتقفل.',
    deleteDone: 'الكود اتمسح.',
    /** The column over the per-row buttons — screen readers only. */
    actions: 'إجراءات',
    empty: 'لسه مفيش أكواد. أول كود من الكارت اللي فوق.',
    emptyFiltered: 'مفيش أكواد بالفلتر ده.',
    moreItems: '+{count}',
    errorGeneric: 'حصلت مشكلة. المحاولة تاني بعد شوية.',
    errorOutside: 'فيه اختيار مش من الكورس ده.',
    prev: 'السابق',
    next: 'التالي',
  ...
  /**
   * «السناتر» — `/admin/centers` and every screen under it: the centres and
   * their weekly slots, one slot's bookings, its attendance sheet, the door
   * scanner, and the money. Plus the «السنتر والحضور» panel on a student's
   * own record, which reads the same data from the other side.
   */
  centers: {
    eyebrow: 'السناتر',
    title: 'السناتر والمواعيد',
    subtitle: 'كل سنتر ومواعيده في الأسبوع، مين حاجز فين، والحضور اللي اتسجّل على الباب.',
    tiles: {
      centers: 'سنتر',
      slots: 'ميعاد',
      booked: 'طالب حاجز',
      attended: 'حضور الشهر ده',
      revenue: 'إيراد الشهر ده',
    },
    newCenter: 'سنتر جديد',
    newSlot: 'ميعاد جديد',
    openScanner: 'تسجيل الحضور',
    openFinance: 'فلوس السناتر',
    empty: 'لسه مفيش سناتر.',
    emptyHint: 'أول سنتر من زرار «سنتر جديد»، وبعدين مواعيده — والطلبة بيحجزوا منها من البروفايل.',
    noSlots: 'لسه مفيش مواعيد في السنتر ده.',
    active: 'شغال',
    inactive: 'موقوف',
    full: 'فل',
    map: 'الخريطة',
    ...
    attendance: 'الحضور',
    scanHere: 'تسجيل حضور',
    backToCenters: 'السناتر',
    /** A slot's fill, over its progress bar. */
    bookedOf: '{booked} من {capacity}',
    bookedUnlimited: '{booked} حاجز · من غير حد',
    seatsLeft: 'فاضل {count}',
    noSeatsLeft: 'مفيش أماكن',
    sessionsHeld: '{count} حصة اتعملت',
    noPrice: 'من غير سعر',
    perClass: '{price} ج للحصة',
    allYears: 'كل الصفوف',
    /** Indexed by `year - 1`. */
    yearNames: ['أولى', 'تانية', 'تالتة'],
    /** The switches on a slot card — `aria-label`s and the words beside them. */
    fullSwitch: 'فل',
    activeSwitch: 'شغال',
    actions: 'إجراءات',
    errorGeneric: 'حصلت مشكلة. المحاولة تاني بعد شوية.',
    ...
    centerForm: {
      createTitle: 'سنتر جديد',
      editTitle: 'تعديل السنتر',
      name: 'اسم السنتر',
      namePlaceholder: 'مثلًا: سنتر النور — المعادي',
      address: 'العنوان',
      addressPlaceholder: 'الشارع والمنطقة وأقرب علامة',
      phone: 'تليفون السنتر',
      mapUrl: 'لينك الخريطة',
      mapUrlHint: 'لينك جوجل ماب — بيظهر للطالب جنب العنوان.',
      isActive: 'السنتر شغال',
      isActiveHint: 'السنتر الموقوف مابيظهرش للطلبة، والحجوزات والحضور القديم بيفضلوا.',
      badName: 'الاسم لازم يبقى حرفين على الأقل.',
      badMap: 'لينك الخريطة مش مظبوط — لازم يبدأ بـ https://',
      save: 'حفظ',
      saving: 'بيتحفظ…',
      cancel: 'إلغاء',
    },
    ...
    slotForm: {
      createTitle: 'ميعاد جديد — {center}',
      editTitle: 'تعديل الميعاد',
      day: 'اليوم',
      start: 'من الساعة',
      end: 'لحد الساعة',
      year: 'الصف',
      capacity: 'عدد الأماكن',
      capacityHint: 'فاضي = من غير حد.',
      price: 'سعر الحصة (جنيه)',
      priceHint: 'بيتسجّل مع كل حضور — ومنه إيراد السنتر.',
      label: 'اسم المجموعة (اختياري)',
      labelPlaceholder: 'مثلًا: مجموعة ١',
      isFull: 'فل',
      isFullHint: 'مفيش حجز جديد في الميعاد ده — واللي حاجز بيفضل.',
      isActive: 'الميعاد شغال',
      isActiveHint: 'الميعاد الموقوف مابيظهرش للطلبة ولا على الباب.',
      badTimes: 'ميعاد النهاية لازم يبقى بعد البداية.',
      badCapacity: 'عدد الأماكن لازم يبقى رقم صحيح أكبر من صفر.',
      badPrice: 'السعر لازم يبقى رقم من غير سالب.',
      save: 'حفظ',
      saving: 'بيتحفظ…',
      cancel: 'إلغاء',
    },
    ...
    confirm: {
      deleteCenterTitle: 'حذف «{name}»؟',
      deleteCenterBody: 'السنتر ومواعيده هيتمسحوا نهائي.',
      deleteSlotTitle: 'حذف الميعاد؟',
      deleteSlotBody: '«{slot}» هيتمسح نهائي.',
      /** The 409 — a centre or slot with bookings or attendance behind it. */
      hasHistory:
        'مينفعش يتمسح — عليه حجوزات أو حضور متسجّل، والحذف كان هيمسح السجل ده. الإيقاف بيخفيه عن الطلبة ويحافظ على كل حاجة.',
      deactivateInstead: 'إيقاف بدل الحذف',
    ...
    toasts: {
      ...
      deactivated: 'اتوقف.',
      activated: 'اشتغل.',
      markedFull: 'الميعاد بقى فل.',
      markedOpen: 'الميعاد اتفتح للحجز تاني.',
    },

    /** `/admin/centers/slots/[slotId]` — who booked one slot. */
    bookings: {
      eyebrow: 'حجوزات الميعاد',
      tiles: {
        booked: 'طالب حاجز',
        sessions: 'حصة اتعملت',
        rate: 'نسبة الحضور',
      ...
      unlimited: 'من غير حد',
      empty: 'لسه محدش حجز في الميعاد ده.',
      emptyHint: 'الطالب بيحجز من البروفايل، أو من ملفه في «الطلبة».',
      number: 'ID',
      student: 'الطالب',
      phone: 'موبايل الطالب',
      fatherPhone: 'ولي الأمر',
      year: 'الصف',
      record: 'الحضور',
      bookedOn: 'حجز {date}',
      attendedCount: 'حضر {count}',
      absentCount: 'غاب {count}',
      noClassesYet: 'لسه مفيش حصص',
      whatsapp: 'واتساب',
      whatsappFather: 'واتساب ولي الأمر',
      openStudent: 'ملف الطالب',
      studyTypes: { general: 'عام', azhari: 'أزهري' },
    },

    /** `/admin/centers/slots/[slotId]/attendance` — the sheet. */
    sheet: {
      eyebrow: 'كشف الحضور',
      from: 'من',
      to: 'لحد',
      ...
      reset: 'آخر ١٢ أسبوع',
      export: 'تحميل Excel',
      exportEmpty: 'مفيش حاجة تتحمّل.',
      tiles: {
        sessions: 'حصة اتعملت',
        avgPresent: 'متوسط الحضور في الحصة',
        absences: 'غياب',
        guests: 'حضروا من برّه الميعاد',
      },
      student: 'الطالب',
      number: 'ID',
      phone: 'الموبايل',
      ...
      present: 'حاضر',
      absentCell: 'غايب',
      notBooked: 'مش محجوز وقتها',
      legendTitle: 'المفتاح',
      noSessions: 'مفيش حصص اتعملت في الفترة دي.',
      noSessionsHint:
        'الحصة بتتحسب من أول طالب يتسجّل على الباب — واليوم اللي مفيهوش ولا تسجيل إجازة، ومحدش بيتحسب غايب فيه.',
      noRows: 'مفيش طلبة حاجزين في الميعاد ده في الفترة دي.',
      guestsNote: '{count} طالب حضروا في حصص الميعاد ده من غير ما يكونوا حاجزين فيه — مش في الكشف.',
      badRange: 'تاريخ البداية لازم يبقى قبل النهاية.',
      scrollHint: 'الكشف بيتحرك يمين وشمال.',
    },

    /** `/admin/centers/scan` — the phone at the door. */
    scan: {
      eyebrow: 'على الباب',
      title: 'تسجيل الحضور',
      subtitle: 'الكاميرا على الـQR اللي في بروفايل الطالب — أو جهاز الباركود في خانة الكود.',
      slot: 'الميعاد',
      slotNow: 'دلوقتي',
      slotInactive: 'موقوف',
      present: 'حاضر',
      presentUnknown: 'لسه',
      sessionCount: '{count} تسجيل من الجهاز ده',
      startCamera: 'تشغيل الكاميرا',
      stopCamera: 'إيقاف الكاميرا',
      flashOn: 'تشغيل الفلاش',
      flashOff: 'إطفاء الفلاش',
      cameraStarting: 'بنفتح الكاميرا…',
      cameraIdle: 'الكاميرا مقفولة — «تشغيل الكاميرا» وبعدين الكارت قدامها.',
      cameraDenied:
        'المتصفح مش مسموح له يفتح الكاميرا. إذن الكاميرا بيتفتح من إعدادات الموقع (علامة القفل جنب اللينك)، وبعدين «تشغيل الكاميرا» تاني.',
      cameraMissing: 'مفيش كاميرا على الجهاز ده — خانة الكود شغالة.',
      cameraBusy: 'الكاميرا مفتوحة في برنامج تاني. قفله وجرّب تاني.',
      cameraInsecure: 'الكاميرا بتشتغل على https بس — خانة الكود شغالة.',
      cameraFailed: 'الكاميرا ماشتغلتش — خانة الكود شغالة.',
      aim: 'الـQR جوّه المربع',
      manualLabel: 'الكود أو رقم الطالب',
      manualPlaceholder: 'ST1234 أو 1234',
      manualHint: 'جهاز الباركود بيكتب هنا لوحده — أو الرقم بالإيد وبعدين Enter.',
      manualSubmit: 'تسجيل',
      recorded: 'تم تسجيل الحضور ✓',
      already: 'اتسجّل قبل كده',
      notBookedHere: 'مش محجوز في الميعاد ده',
      toastRecorded: '{name} — حاضر',
      toastAlready: '{name} — اتسجّل قبل كده',
      toastNotBooked: '{name} — مش محجوز في الميعاد ده',
      number: 'رقم',
      badCode: 'الكود ده مش كود طالب.',
      unknownStudent: 'مفيش طالب بالرقم ده.',
      forbidden: 'الحساب ده مش مسموح له يسجّل حضور.',
      slotGone: 'الميعاد ده مش موجود — الصفحة محتاجة تحديث.',
      offline: 'مفيش اتصال. المحاولة تاني.',
      failed: 'التسجيل ماتمّش. المحاولة تاني.',
      history: 'آخر التسجيلات',
      historyEmpty: 'لسه مفيش تسجيلات من الجهاز ده.',
      undo: 'إلغاء',
      undone: 'اتلغى',
      undoDone: 'الحضور اتلغى.',
      undoFailed: 'الإلغاء ماتمّش.',
      noSlots: 'مفيش مواعيد شغالة.',
      noSlotsHint: 'الميعاد بيتعمل من صفحة السناتر، وبعدين بيظهر هنا.',
    },

    /** `/admin/centers/finance`. */
    finance: {
      eyebrow: 'الحسابات',
      title: 'فلوس السناتر',
      subtitle: 'كل حضور بيتسجّل بسعر الحصة وقتها — ومنه إيراد كل سنتر وكل ميعاد في الشهر.',
      prev: 'الشهر اللي قبله',
      next: 'الشهر اللي بعده',
      thisMonth: 'الشهر ده',
      total: 'إيراد الشهر',
      attendances: 'حضور في الشهر',
      average: 'متوسط الحضور الواحد',
      centers: 'سنتر ليه حضور',
      empty: 'مفيش حضور متسجّل في الشهر ده.',
      share: '{percent}% من الشهر',
      attendancesCount: '{count} حضور',
      slotsTitle: 'المواعيد',
    },

    /** The «السنتر والحضور» panel and the three fields on a student's record. */
    student: {
      title: 'السنتر والحضور',
      studentNumber: 'ID',
      studyType: 'نوع الدراسة',
      attendanceMode: 'نوع الحضور',
      attendanceModeHint: '«أونلاين» بيلغي حجز السنتر لو فيه.',
      studyTypes: { general: 'عام', azhari: 'أزهري' },
      attendanceModes: { online: 'أونلاين', center: 'سنتر' },
      unknown: 'مش متسجّل',
      booking: 'الحجز',
      noBooking: 'مش حاجز في أي ميعاد.',
      bookedOn: 'من {date}',
      moveLabel: 'نقل الحجز',
      noSlot: 'من غير حجز (أونلاين)',
      inactiveSlot: '{slot} (موقوف)',
      fullSlot: '{slot} (فل)',
      saveBooking: 'حفظ الحجز',
      savingBooking: 'بيتحفظ…',
      bookingSaved: 'الحجز اتحفظ.',
      attended: 'حضر',
      absent: 'غاب',
      rate: 'نسبة الحضور',
      entries: 'سجل الحصص',
      noEntries: 'لسه مفيش حصص في سجله.',
      present: 'حاضر',
      absentEntry: 'غايب',
      unavailable: 'سجل السنتر مش متاح دلوقتي.',
      openBookings: 'طلبة الميعاد',
      openSheet: 'كشف الحضور',
      moreEntries: 'و{count} حصة كمان',
    },
  },
  ...
  books: {
     ...
     *  الصندوق. */
    /* ── محجوز للمراجعة ────────────────────────────────────────────────────
       الطلب مدفوع، بس قراية الإيصال لقت حاجة تستاهل عين بني آدم قبل ما الطرد
       يتحرك. الشارة هنا لإن الطلب بيختفي من كشف التعبئة ومن أزرار الشحن
       بالجملة — وطلب بيختفي من غير ما اللستة تقول ليه هو طرد شكله ضايع. */
    heldBadge: 'محجوز للمراجعة',
    heldAmountShort: 'المبلغ على الإيصال أقل من المطلوب',
    heldDuplicateReceipt: 'نفس إيصال التحويل على طلب تاني',
    /** «قريت {read} والمطلوب {owed}» — الرقمين جنب بعض عشان القرار ياخد ثانية. */
    heldAmounts: 'قريت {read} ج والمطلوب {owed} ج',
    /** الزرار اللي بيرفع الحجز. فعل ماضي عن الأدمن نفسه: هو راجعه. */
    reviewOk: 'راجعته، كمّل',
    reviewOkWorking: 'بنرفع الحجز…',
    reviewOkDone: 'اتفك الحجز، الطلب رجع للقايمة.',
    reviewOkFailed: 'مقدرناش نرفع الحجز دلوقتي. جرّب تاني.',
    /** ── رفع الحجز بالجملة ───────────────────────────────────────────────
     *  نفس الزرار بس على التحديد كله. المراجعة بتتعمل طلب طلب، بس القرار
     *  بيتاخد مرة واحدة — وحجز ناسي مرفوعش معناه طرد مش هيطلع في كروت
     *  الشحن ومحدش واخد باله. */
    bulkReviewOkButton: 'راجعتهم، كمّل',
    /** `{count}` — بيقول بالنص إيه اللي هيحصل بعديها، إن الطلبات دي هتبقى
     *  عادية زي أي طلب مدفوع وتطلع في كروت الشحن ولستة المطبعة. */
    bulkReviewOkConfirm:
      'هترفع الحجز عن {count} طلب، ويرجعوا عاديين مع الباقي في كشف التعبئة وكروت الشحن. مفيش أي رسايل هتتبعت. تمام؟',
    /** `{count}` */
    bulkReviewOkDone: 'اتفك الحجز عن {count}',
    /** لما التحديد كله مفيهوش ولا طلب محجوز — مش خطأ، بس مفيش حاجة اتعملت. */
    bulkReviewOkNone: 'مفيش طلب محجوز في اللي محدّد.',
    /** زرار التوليبار — بيرفع الحجز عن كل المحجوزين في نفس المدى والفلاتر
     *  اللي على الشاشة، مش عن التحديد. «حدّد اللي في المدى» ما بيشوفش الطلب
     *  المحجوز أصلاً (هو مش في كشف التعبئة)، فمن غير الزرار ده مفيش طريقة
     *  توصل للمحجوزين كلهم من غير ما تدوّر عليهم صف صف. */
    bulkReviewOkRange: 'ارفع الحجز عن المحجوزين',
    bulkReviewOkRangeWorking: 'بنرفع الحجز…',
    bulkReviewOkRangeHint:
      'بيرفع الحجز عن كل الطلبات المحجوزة في نفس المدى والفلاتر دي، فيرجعوا في كشف التعبئة وكروت الشحن.',
    /** `{count}` */
    bulkReviewOkRangeConfirm:
      'فيه {count} طلب محجوز للمراجعة في المدى ده. هترفع الحجز عنهم كلهم ويرجعوا عاديين في كشف التعبئة وكروت الشحن. مفيش أي رسايل هتتبعت. تمام؟',
    bulkReviewOkRangeEmpty: 'مفيش طلبات محجوزة في المدى ده.',
