 ...
 *
 * الكود بقى ٦ خانات (٤٠^٦ ≈ ٤ مليار) بدل ٢٦ — بطلب صاحب المنصة، عشان الأب
 * بيكتبه في تليفون. فالحد ده بقى هو اللي **شايل** التخمين، مش طول الكود:
 * سكريبت من عنوان واحد بيوصل لساعة قفل بعد ٢٠ محاولة. وهو برضه اللي بيكشف
 * كود اتسرّب أو اتنشر في جروب — من غير عدّاد محدش كان هيعرف.
 *
...
export class GuardianSessionService {
   ...
   *
   * ولو ريديس وقع، الدخول **بيعدّي**: قفل البوابة على كل الآباء عشان عدّاد
   * مش شغّال بيكلّف أكتر مما بيحمي. والسقف اللي بيفضل شغّال ساعتها هو
   * `@Throttle` على الراوت نفسه (`GUARDIAN_SIGN_IN_THROTTLE`).
   */
