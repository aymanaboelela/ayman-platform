...
function RobotMascot() {
  return (
    <svg className="lp-robot" viewBox="0 0 120 132" fill="none" aria-hidden="true">
      ...
      {/* head */}
      <rect x="28" y="20" width="64" height="50" rx="18" fill="#241708" stroke="url(#lp-bot)" strokeWidth="2.5" />
      <rect x="37" y="30" width="46" height="30" rx="12" fill="#0d0803" />
      <circle cx="51" cy="45" r="5.5" fill="#fbbf24" />
      <circle cx="69" cy="45" r="5.5" fill="#fbbf24" />
      <path d="M52 55c3 3 13 3 16 0" stroke="#ff5a3c" strokeWidth="2.6" strokeLinecap="round" />
      {/* body */}
      <rect x="34" y="72" width="52" height="46" rx="16" fill="#241708" stroke="url(#lp-bot)" strokeWidth="2.5" />
      <circle cx="60" cy="92" r="7" fill="#ff5a3c" />
      <rect x="48" y="105" width="24" height="6" rx="3" fill="#3a2712" />
      {/* arms */}
      <rect x="20" y="78" width="9" height="26" rx="4.5" fill="#241708" stroke="url(#lp-bot)" strokeWidth="2" />
      <rect x="91" y="78" width="9" height="26" rx="4.5" fill="#241708" stroke="url(#lp-bot)" strokeWidth="2" />
    </svg>
  );
}
