...
export const boardCopy = {
  ...
  /**
   * الكود اللي بيقعد جنب الافتتاحية.
   *
   * ⚠️ **بيشتغل فعلًا، والتعليق عربي عن قصد.** لوحة فيها رموز مظبوطة الشكل
   * وبس هي زينة لابسة هدوم محتوى، وأي حد بيعرف بايثون بيكشفها من نظرة.
   * تلات سطور هي الميزانية كلها: متغيّر، ونداء، والسطر اللي بيطلع — قصيرة
   * كفاية إن حد عمره ما برمج يقراها حرف حرف.
   *
   * ومكانها هنا مش في `ar.ts` لنفس سبب باقي الملف: دي كلمات كومبوننت واحد.
   */
  heroCode: {
    label: 'أول برنامج هتكتبه',
    lines: [
