...
export const copy = {
  ...
  settings: {
    devices: {
      title: "أجهزتي",
      subtitle:
        "الأجهزة اللي حسابك مفتوح عليها دلوقتي. لو فيه جهاز مش بتاعك، اقفله من هنا.",
  ...
  landing: {
    ...
    feature1Body:
      "مفيش قفزات. المفهوم الجديد بيتبني على اللي فهمته قبله، بأمثلة كود شغّالة قدامك.",
    feature2Title: "تصحيح في نفس اللحظة",
    feature2Body:
      "تعرف غلطك وإنت لسه فاكر السؤال، ومعاه مراجعة بتوضّح الإجابة الصح وسببها.",
    feature3Title: "تقدّمك متسجّل لوحده",
    feature3Body:
      "كل درس بتقفله بيتحفظ، فتعرف وصلت فين ومحتاج ترجع لفين من غير ما تفتكر.",
    ...
    finalLead:
      "الحساب بياخد دقيقة، وأول محاضرة مفتوحة قدامك على طول ومن غير فلوس.",
    ...
    trackEssentialsBody:
      "المصطلحات والأفكار اللي بتتكرر في أي لغة برمجة، في جلسة واحدة قصيرة.",
    trackEssentialsCta: "ابدأ من هنا",
    trackYear1Tag: "المسار · 01",
    trackYear1Title: "الصف الأول",
    trackYear1Body:
      "كورسات أولى بكالوريا: شرح المنهج، تمارين، ومراجعة قبل كل امتحان.",
    trackYear1Cta: "افتح كورسات أولى",
    trackYear2Tag: "المسار · 02 — نشط",
    trackYear2Title: "الصف الثاني",
    trackYear2Body:
      "كورسات تانية بكالوريا: شرح المنهج، تمارين، ومراجعة قبل كل امتحان.",
    ...
    coursesLead:
      "كل كورس فيه شرح مسجّل، تمارين، واختبارات — مرتّب بالصف والمسار.",
    ...
    faq1A:
      "من مسار التأسيس. بيشرحلك المصطلحات والأفكار الأساسية الأول، وبعدين تدخل على الكود بتمارين صغيرة بتكبر معاك.",
    faq2Q: "هتفرّج بس ولا هكتب بإيدي؟",
    faq2A:
      "هتكتب من أول محاضرة. كل جزئية وراها تمرين، وفيه محرّر شغّال جوه المنصة تجرّب فيه من غير ما تنزّل أي برنامج.",
    faq3Q: "أعرف إزاي إني فاهم فعلًا؟",
    faq3A:
      "كل درس وراه اختبار قصير بيتصحّح فورًا، ونتايجك كلها بتتجمّع في صفحتك عشان تشوف مستواك ماشي فين.",
    faq4Q: "المنصة دي لمين بالظبط؟",
    faq4A:
      "لطلبة البكالوريا المصرية اللي بياخدوا البرمجة وعلوم الحاسب — من اللي لسه بيبدأ لحد اللي بيجهّز للامتحان النهائي.",
    ...
    playLead:
      "المحرّر ده شغّال جوه الصفحة من غير أي تنصيب. عدّل في المثال، دوس شغّل، والنتيجة أو رسالة الخطأ هتطلعلك تحت على طول.",
    playRun: "شغّل الكود",
    playRunning: "بيشتغل…",
    ...
    whyLead:
      "كل حاجة هنا مبنية على إنك تجرّب بنفسك. التفرّج لوحده مش بيعلّم برمجة.",
    whyLeadSecondary:
    ...
    faq6A:
      "تختار كورس صفّك وتمشي بالترتيب: فيديو، وبعده تمرين، وبعده اختبار قصير. الدرس ما بيتقفلش غير لما تخلّص التلاتة.",
    faq7Q: "هطلع من الكورس عارف إيه؟",
    faq7A:
      "المتغيرات والدوال والشروط والحلقات والمصفوفات، وبعدين تطبيق على منهج صفّك لحد ما تبني مشروع كامل شغّال.",
  },
  years: {
    title: "كورسات",
  ...
  essentials: {
    ...
    leadBefore:
      "المصطلحات اللي بتتكرر في أي لغة برمجة، كل واحد منهم في سطرين. تخلّصهم وتبقى",
    leadCode: "ready = true",
    leadAfter: "بجد.",
    cta: "اختار صفّك",
    listTitle: "١٢ مصطلح مش هتعرف تكمّل من غيرهم",
    listLead:
      "تعريف واحد واضح لكل مصطلح — بالعربي، ومعاه اسمه بالإنجليزي زي ما هتلاقيه في أي كود.",
    t1Ar: "متغيّر",
    ...
    t7Ar: "نوع البيانات",
    t7Body:
      "القيمة دي رقم ولا نص ولا صح/غلط — النوع بيحدّد إيه اللي ينفع تعمله بيها.",
    t8Ar: "مُعامل",
    ...
    t12Ar: "خوارزمية",
    t12Body:
      "ترتيب الخطوات اللي بيحل المسألة — الفكرة نفسها قبل ما تتحوّل لكود.",
  ...
  library: {
    ...
    title: "الكورسات",
    subtitle:
      "كل الكورسات المنشورة، مرتّبة بالصف والمسار — وكورساتك إنت في الأول.",
    ...
    notEnrolledBody:
      "الكورس مجاني بالكامل — اضغط ابدأ وهتفتح لك أول محاضرة على طول.",
  ...
  playground: {
    ...
    title: "جرّب الكود",
    subtitle:
      "اكتب كود وشغّله على طول. مافيش حاجة بتتحفظ ولا بتتصحّح — المكان ده للتجريب.",
    ...
    pythonNoPackages:
      "المكتبات الخارجية زي numpy مش متاحة هنا — بايثون الأساسية بس.",
  ...
  course: {
     ...
     */
    startNote:
      "اضغط شغّل — لو داخل بحسابك هتتفرّج على طول، ولو لسه هنسجّلك الأول.",
    /**
  ...
  dashboard: {
    ...
    emptyBody:
      "اختار كورس صفّك ومساره، واشترك فيه، وهيبان هنا على طول مع تقدّمك فيه.",
    ...
    stepQuizBody:
      "كل درس وراه اختبار قصير. درجتك بتظهر هنا على طول بعد ما تسلّم.",
  ...
  results: {
    ...
    emptyBody:
      "كل درس وراه امتحان قصير. أول ما تخلّص واحد، درجتك ومراجعة إجاباتك هيبانوا هنا.",
    emptyCta: "روح لمسارك",
  },
  ...
  assistant: {
    ...
    courses: {
      ...
      empty:
        "مفيش كورسات مفتوحة في اللحظة دي. لو عايز تعرف أول ما ينزل جديد، كلّم أيمن وسيبله رقمك.",
    ...
    escalate: {
      ...
      leadGuest:
        "اكتب سؤالك وسيبلنا اسمك ورقم الواتساب. الرد هيوصلك هنا لو رجعت، وعلى رقمك.",
  ...
  admin: {
    ...
    course: {
      ...
      subject: "المادة",
      subjectEmpty:
        "مفيش مواد متاحة للاختيار ده — جرّب نظام أو صف أو مسار تاني",
      status: "الحالة",
      statusDraft: "مسودة",
    ...
    section: {
      ...
      delete: "حذف القسم",
      deleteConfirm:
        "هيتمسح القسم وكل المحاضرات اللي جواه. الإجراء ده مش هيترجع.",
    ...
    lesson: {
      ...
      videoUrlHint:
        "بناخد كود الفيديو (11 حرف) بس — الباقي بيتشال ومحدش بيفتح الرابط",
      ...
      delete: "حذف",
      deleteConfirm:
        "هتتمسح المحاضرة وكل اللي جواها — الفيديو والمواد. الإجراء ده مش هيترجع.",
      deleteBlockedAttempts:
      ...
      removeVideoConfirm:
        "هيتشال الفيديو من المحاضرة. المحاضرة نفسها هتفضل موجودة.",
      ...
      posterHint:
        "بتظهر قبل ما الفيديو يشتغل. لو سيبتها فاضية هتظهر صورة يوتيوب.",
    ...
    settings: {
      ...
      seoDescriptionHint:
        "حتى 160 حرف — الوصف اللي بيظهر تحت العنوان في نتائج البحث",
    ...
    students: {
      ...
      roleChangeReasonPlaceholder:
        "وضّح سبب تغيير الدور — هيتسجل في سجل النشاط",
    ...
    media: {
       ...
       */
      uploadTooLarge:
        "الصورة كبيرة أوي — الحد الأقصى ٨ ميجا. صغّرها وحاول تاني.",
      uploadBadType:
      ...
      cropHint:
        "اسحب الصورة عشان تحرّكها، والشريط اللي تحت بيكبّرها. اللي جوّه الإطار هو اللي هيتحفظ.",
      cropZoom: "تكبير",
    ...
    home: {
      ...
      addRotating: "أضف سطر",
      rotatingHint:
        "السطر التاني في العنوان بيلف على دول. سيبها فاضية لو عايزه ثابت.",
  ...
  news: {
    ...
    subtitle:
      "مقالات قصيرة في أساسيات البرمجة وعلوم الحاسب — بالعربي، وبأمثلة كود شغّالة.",
    ...
    relatedBody:
      "الكلام اللي فوق ده مقدّمة. الشرح الكامل بالفيديو والتمارين والاختبارات في «{course}».",
    relatedCta: "افتح الكورس",
    /** Shown instead of `related*` when the article has no course attached. */
    fallbackTitle: "ابدأ من الأول",
    fallbackBody:
      "لو المقالة دي عجبتك، المنهج كامل مرتّب بالصف والمسار — والكورسات كلها مجانية.",
  ...
  adminNews: {
    ...
    fieldTitle: "العنوان",
    fieldTitleHint:
      "خلّيه سؤال زي ما الطالب هيكتبه في البحث — «إيه هي الحلقة التكرارية؟» بتتبحث، «الحلقات» لأ.",
    fieldSlug: "الرابط",
    fieldSlugHint: "بالعربي عادي. من غير مسافات ولا نقط ولا شرطة مائلة.",
    fieldExcerpt: "الملخّص",
    fieldExcerptHint:
      "دي نفسها اللي بتظهر تحت العنوان في نتايج جوجل. ١٦٠ حرف بالكتير.",
    fieldBody: "المقالة",
    fieldBodyHint:
      "Markdown: ## للعنوان، - للنقط، ``` للكود. الـ HTML بيتعرض كنص مش بيتنفّذ.",
    fieldCourse: "الكورس المرتبط",
    fieldCourseNone: "من غير كورس",
    fieldCourseHint:
      "المقالة بتقفل بزرار على الكورس ده. سيبه فاضي وهتقفل على صفحة الكورسات.",
    save: "احفظ",
    saving: "بيحفظ…",
    saved: "اتحفظ",
  ...
  examGate: {
    ...
    onceExamBody:
      "دي محاولتك الأصلية. بعدها ليك محاولة تحسين واحدة، وأعلى درجة هي اللي بتتحسب.",
    timedBody:
      "معاك {minutes} دقيقة من أول ما تضغط ابدأ، والوقت بيمشي حتى لو قفلت الصفحة.",
    ...
    improveDifferentBody:
      "ده امتحان تاني بأسئلة غير اللي امتحنتها. ذاكر الأول، مش هينفع تعتمد على اللي فات.",
    improveSafeTitle: "درجتك الحالية في أمان",
    improveSafeBody:
      "أعلى درجة في الاتنين هي اللي بتتحسب. لو جبت أقل، درجتك الأولى هي اللي هتفضل.",
  ...
  quizAdmin: {
    ...
    newQuestionPublishFailed:
      "السؤال اتحفظ في البنك بس مانشرش. افتحه من بنك الأسئلة واضغط «انشر السؤال».",
    /** Saved AND published, but attaching it to this exam failed. */
    newQuestionAttachFailed:
    ...
    bulkImportHint:
      "الصق الأسئلة، كل سؤال في فقرة، وحدد الإجابة بسطر ANSWER أو الإجابة",
    bulkImportExample:
    ...
    slotSharedWarning:
      "السؤال ده مستخدم في {n} امتحان — أي تعديل هنا بيتغيّر فيهم كلهم.",
    ...
    shortcutsHint:
      "Ctrl/⌘+Enter للحفظ — Escape للإغلاق — Enter في آخر اختيار يضيف اختيار جديد",
  ...
  quizErrors: {
    ...
    shortAnswerNeedsFullCredit:
      "لازم يكون فيه نموذج إجابة واحد على الأقل بوزن 1",
  ...
  legal: {
    ...
    shareBody:
      "مابنبيعش بياناتك ومابنأجرهاش لحد، ومابنستخدمهاش في إعلانات. الأطراف التانية الوحيدة اللي ليها علاقة بالموقع:",
    shareCloudflare:
    ...
    cookiesBody:
      "بنستخدم كوكيز ضرورية بس: واحدة بتفضّلك مسجّل دخول، وواحدة بتحمي الفورمات من التزوير. مفيش كوكيز إعلانات ولا كوكيز تتبّع عبر المواقع.",
