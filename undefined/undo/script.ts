...
export function isNextChoice(
  choice: AssistantChoice,
): choice is AssistantChoiceNext {
  return "next" in choice;
}

export function isLinkChoice(
  choice: AssistantChoice,
): choice is AssistantChoiceLink {
  return "href" in choice;
}

export function isEscalateChoice(
  choice: AssistantChoice,
): choice is AssistantChoiceEscalate {
